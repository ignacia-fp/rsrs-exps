...
//+
Physical Surface(1091) -= {1067};

//+
Physical Surface(1091) -= {1069};
//+
Physical Surface(1091) -= {944};
//+
Physical Surface(1091) -= {1002};
//+
Physical Surface(1091) -= {968};
//+
Physical Surface(1091) -= {966};
//+
Physical Surface(1091) -= {1015};
//+
Physical Surface(1091) -= {1003};
//+
Physical Surface(1091) -= {902};
//+
Physical Surface(1091) -= {1012};
//+
Physical Surface(1091) -= {966};
//+
Physical Surface(1091) -= {1000};
//+
Physical Surface(1091) -= {644};
//+
Physical Surface(1091) -= {644};
//+
Physical Surface(1091) -= {642};
//+
Physical Surface(1091) -= {993};
//+
Physical Surface(1091) -= {1009};
//+
Physical Surface(1091) -= {1064};
//+
Physical Surface(1091) -= {1062};
//+
Physical Surface(1091) -= {1072};
//+
Physical Surface(1091) -= {898};
//+
Physical Surface(1091) -= {896};
//+
Physical Surface(1091) -= {904};
//+
Physical Surface(1091) -= {906};
//+
Physical Surface(1091) -= {1006};
//+
Physical Surface(1091) -= {996};
//+
Physical Surface(1091) -= {1067};
//+
Physical Surface(1091) -= {1067};
...
Physical Surface(1091) -= {1015};
//+
Physical Surface(1091) -= {964};
//+
Physical Surface(1091) -= {962};
//+
Physical Surface(1091) -= {1051};
//+
Physical Surface(1091) -= {1059};
//+
Line(1066) = {1190, 1219};
//+
Curve Loop(1089) = {1066, 1026, 1027, 489};
//+
Plane Surface(1074) = {1089};
//+
Curve Loop(1090) = {447, 991, 1007, 453, 1053, -454, -1004, -994, 493, 558, -561, -560, -557, -491, 1066, -1013, 472, -1044, -471, -1010, -997, -448};
//+
Surface(1075) = {1090};
//+
Line(1067) = {1173, 1174};
...
Line(1074) = {1194, 1219};
//+
Curve Loop(1091) = {454, -1053, -453, -1067};
//+
Surface(1075) = {1091};
//+
Curve Loop(1092) = {1004, 1067, -1007, 1068};
//+
Surface(1076) = {1092};
//+
Curve Loop(1093) = {994, -1068, -991, 1069};
//+
Surface(1077) = {1093};
//+
Curve Loop(1094) = {1069, 493, 558, -1070, 447};
//+
Plane Surface(1078) = {1094};
//+
Curve Loop(1095) = {561, -1070, 448, 1071};
//+
Plane Surface(1079) = {1095};
//+
Curve Loop(1096) = {560, -1071, 1072};
//+
Plane Surface(1080) = {1096};
//+
Curve Loop(1097) = {1072, -557, -491, 1073};
//+
Plane Surface(1081) = {1097};
//+
Curve Loop(1098) = {1073, 997, 1074, -1066};
//+
Plane Surface(1082) = {1098};
//+
Line(1075) = {1171, 1172};
//+
Curve Loop(1099) = {1075, 471, 1044, -472};
//+
Surface(1083) = {1099};
//+
Curve Loop(1100) = {1013, -1074, 1010, -1075};
//+
Surface(1084) = {1100};
//+
Recursive Delete {
  Point{2219}; Point{2218}; Point{2195}; Point{2198}; 
}
//+
Recursive Delete {
  Point{2197}; Point{2196}; Point{2194}; Point{2193}; Point{2192}; Point{2208}; Point{2130}; Point{2129}; Point{2134}; Point{2175}; Point{2176}; Point{2121}; Point{2122}; Point{2069}; Point{2070}; Point{1987}; Point{1988}; Point{2047}; Point{2050}; 
}
//+
Recursive Delete {
  Point{2289}; Point{2290}; Point{2265}; Point{2305}; Point{2267}; Point{2266}; Point{2263}; Point{2264}; Point{2262}; Point{2277}; Point{2345}; Point{2344}; Point{2315}; Point{2316}; Point{2318}; Point{2317}; Point{2312}; Point{2314}; Point{2313}; Point{2319}; Point{2320}; 
}
//+
Recursive Delete {
  Point{1956}; 
...
//+
Recursive Delete {
  Point{1799}; Point{1762}; 
}
//+
Recursive Delete {
  Point{1552}; Point{1555}; 
}
//+
Recursive Delete {
  Point{1460}; Point{1463}; 
}
//+
Recursive Delete {
  Curve{512}; 
...
//+
Recursive Delete {
  Point{1810}; Point{1809}; Point{1811}; Point{1814}; Point{1738}; Point{1739}; Point{1734}; Point{1735}; Point{1805}; Point{1806}; Point{1803}; Point{1843}; Point{1851}; Point{1852}; Point{1853}; Point{1855}; Point{1905}; Point{1903}; Point{1900}; Point{1529}; Point{1526}; Point{1525}; Point{1524}; Point{1534}; Point{1533}; Point{1437}; Point{1432}; Point{1433}; Point{1434}; Point{1419}; Point{1416}; Point{1536}; Point{1535}; 
}
//+
Recursive Delete {
  Point{1266}; Point{1263}; Point{1260}; Point{1268}; Point{1267}; Point{1261}; Point{1246}; Point{1247}; Point{1244}; 
}
//+
Recursive Delete {
  Point{1356}; Point{1355}; Point{1353}; Point{1351}; Point{1348}; Point{1350}; Point{1442}; Point{1441}; Point{1334}; Point{1333}; Point{1444}; Point{1443}; 
}
//+
Recursive Delete {
  Point{1363}; Point{1373}; Point{1285}; Point{1274}; 
}
//+
Recursive Delete {
  Point{1459}; Point{1446}; 
}
//+
Recursive Delete {
  Point{1550}; Point{1538}; 
}
//+
Recursive Delete {
  Point{1760}; Point{1756}; 
}
//+
Recursive Delete {
  Point{1753}; Point{1752}; Point{1751}; Point{1750}; Point{1796}; Point{1819}; Point{1820}; Point{1793}; Point{1794}; Point{1871}; Point{1866}; Point{1865}; 
}
//+
Recursive Delete {
  Point{1868}; Point{1870}; Point{1928}; Point{1924}; Point{1925}; Point{1919}; Point{1921}; 
}
//+
Recursive Delete {
  Point{1010}; Point{1012}; Point{1083}; Point{1082}; Point{1056}; Point{1062}; Point{1007}; Point{1008}; Point{1009}; Point{1080}; Point{1079}; 
}
//+
Recursive Delete {
  Point{1058}; Point{1057}; Point{987}; Point{988}; Point{986}; Point{985}; Point{983}; Point{991}; Point{1078}; Point{1076}; Point{1073}; Point{1074}; Point{1000}; Point{1003}; Point{1005}; Point{1006}; 
}
//+
Recursive Delete {
  Point{1064}; Point{1065}; Curve{1070}; 
}
//+
Recursive Delete {
  Point{1063}; 
...
//+
Recursive Delete {
  Point{993}; Point{992}; Point{1061}; Point{1066}; Point{1067}; Curve{1069}; Point{1068}; Point{1069}; Point{995}; 
}
//+
Recursive Delete {
  Point{994}; Point{996}; Point{997}; Curve{494}; 
}
//+
Physical Point(1091) -= {1013, 1085};
//+
Recursive Delete {
  Point{1085}; Point{1013}; 
}
//+
Recursive Delete {
  Point{1027}; Point{1026}; 
}
//+
Recursive Delete {
  Point{1090}; Point{1091}; Point{1088}; Point{1015}; Point{1018}; Point{1019}; Point{1021}; Point{1024}; 
}
//+
Recursive Delete {
  Point{1023}; 
...
//+
Recursive Delete {
  Point{1095}; Point{1092}; 
}
//+
Recursive Delete {
  Point{1094}; Point{1022}; Point{1089}; 
}
//+
Recursive Delete {
  Curve{367}; 
...
//+
Physical Surface(1101) = {972, 979, 977, 974, 1083, 1049, 1047};
//+
Physical Surface(1102) = {1030, 814, 1074, 696, 979, 942, 938, 826, 816, 824, 818, 822, 934, 820, 650, 786, 676, 956, 646, 912, 932, 682, 782, 648, 720, 700, 680, 702, 726, 728, 690, 692, 830, 1023, 1034, 974, 972, 1083, 1047, 1049, 977, 722, 914, 730, 954, 848, 788, 846, 1073, 678, 926, 804, 736, 746, 732, 740, 778, 664, 652, 662, 658, 748, 660, 860, 862, 762, 844, 760, 768, 656, 750, 764, 766, 928, 910, 930, 790, 868, 836, 770, 772, 794, 806, 792, 866, 834, 796, 886, 798, 888, 854, 858, 852, 864, 850, 880, 878, 876, 870, 884, 874, 882, 856, 800, 774, 776, 840, 838, 842, 952, 890, 734, 744, 758, 738, 742, 752, 724, 916, 754, 718, 918, 810, 808, 780, 950, 654, 666, 716, 958, 892, 986, 984, 712, 1043, 1039, 894, 1025, 1041, 1019, 988, 714, 990, 1079, 1078, 1082, 1084, 1081, 1080, 1077, 1076, 1075, 1055, 1057, 784, 832, 698, 694, 688, 686, 684, 922, 920, 924, 828, 1021, 936};
    """
