        ...
        impl TestFramework for $scalar {
            fn test_rsrs_geometry(
                ...
                for &id_tol in id_tols.iter() {
                    ...
                    let mut structured_operator_mat: DynamicArray<$scalar, 2> =
                        structured_operator_fn(&points, kappa);
                    let mut rsrs_algo: Rsrs<$scalar> =
                        Rsrs::new(&structured_operator_mat, tols, &tree);
                    ...
                    let rsrs_factors = rsrs_algo
                        .tree_cycle_and_diag_block_extraction(&structured_operator_mat, options);
                    save_stats(
