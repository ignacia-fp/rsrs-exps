use rlst::{dense::linalg::null_space::Method, prelude::*};

fn _compare_svd_vs_qr(_cols: usize, _rows: usize) {
    ...
    let res = empty_array().simple_mult_into_resize(arr.r_mut(), null_res.null_space_arr.r());
    //Result
    println!(
